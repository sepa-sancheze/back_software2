...
class ComprasLista(APIView):
    ...
    def post(self, request, format = None):
        if request.user.has_perm('Compras.add_compras'):
...
class ComprasUnico(APIView):
    ...
    def put(self, request, pk, format = None):
        if request.user.has_perm('Compras.change_compras'):
            objeto = self.get_objecto(pk)
    ...
    def delete(self, request, pk, format = None):
        if request.user.has_perm('Compras.delete_compras'):
            objeto = self.get_objecto(pk)
            objeto.delete()
...
class DetalleCompraLista(APIView):
    ...
    def post(self, request, format = None):
        if request.user.has_perm('Compras.add_detalleCompra'):
